    ...
    <>
      <AlertDialog open={undoFlow?.kind === "incoming"}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => onRespondUndo(false)}><Trans>拒绝</Trans></AlertDialogCancel>
            <AlertDialogAction onClick={() => onRespondUndo(true)}><Trans>同意</Trans></AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
      <AlertDialog open={rematchIncoming}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => onRespondRematch(false)}><Trans>拒绝</Trans></AlertDialogCancel>
            <AlertDialogAction onClick={() => onRespondRematch(true)}><Trans>同意</Trans></AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
