    ...
    validators: {
      onSubmit: z.object({
        outName: z
          ...
          .trim()
          .min(1, t`名称不能为空`)
          .refine((value) => !/[\\/]/.test(value), t`名称不能包含斜杠`),
      }),
    },
    onSubmit: () => {
      confirmExtract();
          ...
          <FieldGroup className="gap-3">
            ...
            <Field>
              ...
              <div className="flex min-w-0 items-center gap-2">
                <div className="bg-muted min-w-0 flex-1 truncate rounded-md px-2 py-1.5 font-mono text-xs">
