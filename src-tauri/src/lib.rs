...
macro_rules! collect_app_commands {
    ($($($platform_command:ident)::+),* $(,)?) => {
        collect_commands![
            ...
            commands::vault_entries_reorder,
            commands::todo_items_list,
            commands::todo_item_create,
            commands::todo_item_update,
            commands::todo_item_delete,
            commands::data_export,
            commands::data_inspect,
            commands::data_import,
            commands::app_data_usage,
            commands::app_data_clear,
            ...
            commands::poetry_translation_pack_import,
            commands::poetry_translation_packs,
            commands::poetry_translation_pack_delete,
            commands::list_poetry_pack_translations,
